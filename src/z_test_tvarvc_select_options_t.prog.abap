*&---------------------------------------------------------------------*
*& Report Z_TEST_TVARVC_SELECT_OPTIONS_T
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_test_tvarvc_select_options_t.
...
CONSTANTS gc_tvarvc_entry TYPE string VALUE 'Z_TEST_TVARVC_SELECT_OPTIONS_T'.

CREATE OBJECT go_tvarvc TYPE zcl_core_tvarvc.

TRY.
    gt_tvarvc = go_tvarvc->read_select_options_tab( gc_tvarvc_entry ).
